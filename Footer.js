...
if(this.state.days[catchDay] === 'Monday' && catchTime >= 10 && catchTime >= 22){
    response = 'Open Now, Closes at 10:00pm';
} else if(this.state.days[catchDay] === 'Tuesday' && catchTime >= 10 && catchTime >= 22){
     response = 'Open Now, Closes at 10:00pm';
}else if(this.state.days[catchDay] === 'Wednesday' && catchTime >= 10 && catchTime <= 21){
    response ='Open Now, Closes at 10:00pm';
}else if(this.state.days[catchDay] === 'Thursday' && catchTime >= 10 && catchTime >= 22){
    response ='Open Now, Closes at 10:00pm';
                ...
                <div className="footer__foot_hours">
                     ...
                     <h1 className="footer__foot_hours_container--title">Hours</h1>
                         <div className="footer__foot_hours_container--time">
                             <h1 className={`${this.state.classname}`}>{this.state.status}</h1> 
                          </div>
